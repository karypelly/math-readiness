...
function buildAssessmentEmail(assessment: ReadinessState, analysis: AnalysisResult): string {
...
export async function POST(request: Request) {
  ...
  const response = await fetch(RESEND_ENDPOINT, {
    ...
    body: JSON.stringify({
      ...
      subject: `Math readiness assessment — Grade ${assessment.student.grade_entering} — ${assessment.parent.first_name || assessment.parent.email}`,
      html: buildAssessmentEmail(assessment, analysis),
    }),
  })
